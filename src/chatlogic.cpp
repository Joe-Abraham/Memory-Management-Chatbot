...
ChatLogic::ChatLogic()
{
    ...
    // Constructor will be handled by smart pointer.
    // Loading of the images and logic handled in LoadAnswerGraphFromFile().
...
ChatLogic::~ChatLogic()
{
    ...
    // No need of destructor since smart pointers are used everywhere.
